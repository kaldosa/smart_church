...
import com.laonsys.springmvc.extensions.exception.PermissionNotDefinedException;

public class SmartChurchPermissionEvaluator implements PermissionEvaluator {
    private Map<String, Permission> permissionNameToPermissionMap = new HashMap<String, Permission>();
    
    protected SmartChurchPermissionEvaluator() {}

    public SmartChurchPermissionEvaluator(Map<String, Permission> permissionNameToPermissionMap) {
