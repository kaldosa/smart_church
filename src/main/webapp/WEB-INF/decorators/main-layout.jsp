...
@import url("<c:url value='/resources/css/commons.css'  />");
...
@import url("<c:url value='/resources/js/jquery/bootstrap/bootstrap.form.css' />");
/*]]>*/
</style>
...
<body>
    <div id="wapper">
        <page:applyDecorator name="header" page="/WEB-INF/decorators/header.jsp" />
        <hr class="separator" />
        <decorator:body />
        <hr class="separator" />
