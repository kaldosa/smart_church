...
<body>
<page:applyDecorator name="header" page="/WEB-INF/decorators/church-denied-header.jsp" />
</c:if>
<div id="container">
    <div id="content">
        <decorator:body />
...
<c:if test="${!ajaxRequest}">
<page:applyDecorator name="footer" page="/WEB-INF/decorators/church-denied-footer.jsp" />
