...
<div id="writeWrap">
<s:bind path="entity.*">
<c:url var="updateUrl" value="/church/${ourChurch.id}/album/${entity.id}" />
<form:form name="update-form" action="${updateUrl}" method="put" id="update-form" modelAttribute="entity">
<fieldset><legend>교회앨범 수정 폼</legend>
...
<div class="row">
<div class="span7" style="text-align: right;"><a href="<c:url value="/church/${ourChurch.id}/album/${entity.id}/photo"/>" class="btn btn-primary">사진 수정</a></div>
</div>
</dd>
</dl>
</div><!-- writeCon -->
