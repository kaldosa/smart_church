...
<div id="writeWrap">
<c:url var="updateUrl" value="/church/${ourChurch.id}/message/${entity.id}" />
<form:form name="update-form" action="${updateUrl}" method="put" id="update-form" modelAttribute="entity">
<fieldset><legend>1분메세지 수정 폼</legend>
...
<dl>
<dt>제목</dt>
<dd><form:input path="subject" id="subject" maxlength="50" cssClass="input_text input_w500" htmlEscape="true"/></dd>
</dl>
<dl>
<dt><label for="sub-title">소제목</label></dt>
<dd><form:input path="subTitle" type="text" id="sub-title" maxlength="128" cssClass="input_text input_w500" htmlEscape="true"/><div class="ex">128자 이내로 작성해주세요.</div></dd>
</dl>
<dl>
<dt><label for="contents">말씀</label></dt>
<dd>
<form:textarea path="contents" id="contents" cssClass="input_textarea" cols="120" rows="5" cssStyle="width: 520px; height: 100px;" htmlEscape="true" />
