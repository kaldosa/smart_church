...
<c:url var="editUrl" value="/church/${ourChurch.id}/intro" />
<form:form id="create-form" name="introForm" action="${editUrl}" modelAttribute="churchIntro"  method="put" enctype="multipart/form-data">
<fieldset><legend>인사말 폼</legend>

<form:hidden path="introImage.id"/>
