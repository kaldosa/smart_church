...
<dd><form:input path="subject" id="subject" maxlength="50" htmlEscape="true" cssClass="input_text input_w500"/></dd>
</dl>
<dl class="end">
...
<c:if test="${not empty entity.attachment}">
