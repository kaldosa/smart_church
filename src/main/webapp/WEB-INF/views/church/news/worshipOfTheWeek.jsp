...
<div id="titleWrap">
<h3>이번주 예배</h3>
<p class="home">Home &gt; 교회소식 &gt; <span>이번주 예배</span></p>
</div>
...
<table class="infoBox">
    <tr>
        ...
        <th class="input_w150">설교자</th>
        <th class="input_w150">설교 내용</th>
        <th class="input_w150">찬송가</th>
    </tr>
...
<li class="bold"><a href="<c:url value="/church/${ourChurch.id}/worshipOfTheWeek" />">이번주 예배</a></li>
<li><a href="<c:url value="/church/${ourChurch.id}/family" />">새가족 소개</a></li>
</ul>

<sec:authorize ifAnyGranted="ROLE_ADMIN, ROLE_${ourChurch.path}">
<div class="btn_admin"><a href="<c:url value="/church/${ourChurch.id}/worshipOfTheWeek/new" />"><img src="<c:url value="/resources/images/church/info/btn_admin.gif" />" alt="페이지관리" width="112" height="34" /></a></div>
</sec:authorize>
