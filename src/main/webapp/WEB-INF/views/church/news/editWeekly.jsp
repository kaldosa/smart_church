...
<div id="writeWrap">
<c:url var="updateUrl" value="/church/${ourChurch.id}/weekly/${entity.id}" />
<form:form name="updateForm" action="${updateUrl}" method="put" id="update-form" modelAttribute="entity" enctype="multipart/form-data">
<fieldset><legend>교회 주보 수정 폼</legend>
...
<div class="span9" style="margin-top: 20px; text-align: center">
    ...
    <a href="<c:url value="/church/${ourChurch.id}/weekly"/>" class="btn btn-large">취소</a>
</div><!--// 버튼 -->
</div>
