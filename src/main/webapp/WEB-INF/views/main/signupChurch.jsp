...
<div class="page-title"><img src="<c:url value="/resources/images/main/img_application_title.gif"/>" /></div>
        <div class="content_layout">
            <div class="container service-wrap">
                <div id="register-church" class="signup-box">
                <div class="error-container well well-small" style="display: none;"></div><c:url var="signupUrl" value="/application-service/signup"/>
                    <form:form id="register-church-form" class="form-horizontal" modelAttribute="entity" action="${signupUrl}">
                    ...
                    <span class="input-small uneditable-input"><s:eval expression="user.email.split('@')[0]"/></span> @ <span class="input-small uneditable-input"><s:eval expression="user.email.split('@')[1]"/></span>
                    </div>
                    </div>
                    
                    <div class="control-group" >
                    <div class="controls" style="border: 1px solid #666; height: 120px; overflow: auto;">
<div id="provision">
<div class="agreement">
<h6 class="agreement-heading">'SMART CHURCH' 이용약관</h6>

<h6 class="agreement-heading">제1장 총 칙</h6>
...
<h6>제 5 장 계약 해지 및 이용 제한</h6>

<h6>제 17 조 (계약 변경 및 해지)</h6>
<ol class="doc_list">
...
본 약관은 2012년 3월 1일부터 적용됩니다.<br />
                    ...
                    <div class="control-group" style="text-align: right;">
                        <div class="controls">
                            ...
                            <input type="checkbox" name="aggreement"> 약관 동의
                            </label>
                        </div>
                    </div>
                    ...
                    <a href="<c:url value="/application-service"/>" class="btn">취소</a>
                    </div>
                    </div>
                    </form:form>
                </div>
