...
<c:url var="createUrl" value="/notices" />
<form:form id="create-form" action="${createUrl}" method="post" modelAttribute="entity">
...
<input type="image" alt="저장" src="<c:url value="/resources/images/main/btn_save.png" />" />
