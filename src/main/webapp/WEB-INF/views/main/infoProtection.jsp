...
<h1 class="agreement_info">개인정보 취급방침</h1>
...
<p>라온시스(주)('www.smartchurch.com' 이하 'SMART CHURCH')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.</p>
