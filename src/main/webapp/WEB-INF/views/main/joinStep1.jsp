...
<div class="title-image"><img src="<c:url value="/resources/images/main/visual_img.png" />" /></div>
            ...
            <div class="container service-wrap">
                <div id="register-church" class="form-box agree-box">
                <div class="error-container well well-small" style="display: none;"></div><c:url var="step1" value="/join"/>
                    <form:form id="agree-form" class="form-horizontal" modelAttribute="joinFormBean" action="${step1}" method="post">

<div class="control-group" >
<div class="controls" style="border: 1px solid #DDDDDD; border-radius: 4px 0 4px 0; height: 120px; overflow: auto;">
<div id="provision">
<div class="agreement">
...
<div class="control-group" >
<div class="controls" style="border: 1px solid #DDDDDD; border-radius: 4px 0 4px 0; height: 120px; overflow: auto;">
<div id="infoProtection">
<div class="agreement">
<h6 class="agreement-heading">개인정보 취급방침</h6>
    <p class="doc_comment">
        ...
        <li class="topmargin">개인정보 처리방침 변경
            <p>이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.</p>
                    ...
                    <div class="control-group" style="text-align: right;">
                        <div class="controls">
                            <label class="checkbox inline">
                            <input type="checkbox" name="protection"> 개인정보 처리방침 동의
                            </label>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="_step" value="agree"/>
                    </form:form>
                </div>
            </div>
        </div>
    ...
    $('#agree-form').validate({
        ...
        rules: {
            ...
            'email': {
            	required: true,
            	email: true,
            	checkEmail: '<c:url value="/join/isAvailableMail"/>'
            }
        },
        messages: {
            'aggreement': {
